...
;; Parantezlerin, köşeli parantezlerin ve süslü parantezlerin renk kodlanmasını sağlar.
...
;; Kopyalanan veya kesilen metni tutan bir tür "geçmiş") incelemeyi ve düzenlemeyi kolaylaştırır.
...
;; Eşleşen parantezleri göster
(add-hook 'after-init-hook 'show-paren-mode)

;;; Kullanışlı tuş bağlantıları
...
;; Kaçış dizilerini vurgulamak için kullanılir
(require-package 'highlight-escape-sequences)
(add-hook 'after-init-hook 'hes-mode)

;; Bir tuşa basıldığında Emacs'ın sunabileceği tüm olası sonraki tuşları gösterir.
